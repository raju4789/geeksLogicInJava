...
/**
 * Convert from Binary, Octal or Hex to Decimal using Integer.parseInt(String input, 
 * int radix)
 
 * Use Integer.parseInt(String input, int radix) to convert from any type of number to an 
 * Integer.
 * 
 * @author Raju Rockzzz :P
 *
 */
 public class ConversionOthersToDecimal {
	...
	static int convertRadixValueToDecimalOne(String radixValue, int radix){
		...
		for (int i = radixValueLength-1; i >= 0; --i) {
			int charValue=radixValue.charAt(i)-48;
