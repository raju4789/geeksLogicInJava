...
public class TrailingZeroesOfFactorial {
	...
	public static void main(String[] args) {
		int n=100;
		int noOfTrailingZeroes=findTrailingZeroesCount(n);
		System.out.println("No of trailing zeroes in "+n+"! are "+noOfTrailingZeroes);
	}
	
	static int findTrailingZeroesCount(int n){
		int count=0;
